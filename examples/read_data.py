...
if __name__ == "__main__":
    ...
    tags = [
        ...
        "DB1,SINT20",  # => S7Tag(MemoryArea.DB, 1, DataType.SINT, 20, 0, 1) - Read SINT (signed byte -128 to 127) at address 20 of DB1
        "DB1,USINT21",  # => S7Tag(MemoryArea.DB, 1, DataType.USINT, 21, 0, 1) - Read USINT (unsigned byte 0-255) at address 21 of DB1
